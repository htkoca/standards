...
3. **Real text in the DOM.** No content locked in images or canvas; heading and landmark structure follows the [accessibility](../accessibility/SKILL.md) baseline.
...
Extracted from `docs/01-standards/seo.md`, identical across `tkodev-web-v5`, `kindred-web`, and `boilerplate-web`.
